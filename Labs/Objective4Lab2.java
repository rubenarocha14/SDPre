...
public class Objective4Lab2{
  public static void main(String[] args){
    ...
    //TODO prompt the user to get input for all of the above int vars.

    //TODO promt the user to get input for all of the above double vars.

    //TODO print the three ints and their sum.

    //TODO print the three dbls and their sum.
    ...
    double dblSum = dub1+dub2+dub3;
    System.out.println("The sum of " +num1 + "+" +num2 +"+" +num3 + "=" + intSum);
    System.out.println("The sum of " + dub1 + "+" + dub2 + "+" + dub3 + "=" +dblSum);
  }
}
